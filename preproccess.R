######################################################################
## R script to extract datasets, adapted from Mhammedi et al.       ##
######################################################################
...
#### This part is copied from gen-data.R in PAC-Bayes Un-Expected Bernstein paper.
...
#### This part extracts and preprocesses data from 'UCI Data sets' to csv files in preproc folder.


data_option <- "breast-cancer"
df <- gendata( data_option )
write.table(df[1], paste("preproc/", data_option, "-xs.csv", sep=""))
write.table(df[2], paste("preproc/", data_option, "-ys.csv", sep=""))

data_option <- "bank-notes"
df <- gendata( data_option )
write.table(df[1], paste("preproc/", data_option, "-xs.csv", sep=""))
write.table(df[2], paste("preproc/", data_option, "-ys.csv", sep=""))

data_option <- "haberman"
df <- gendata( data_option )
write.table(df[1], paste("preproc/", data_option, "-xs.csv", sep=""))
write.table(df[2], paste("preproc/", data_option, "-ys.csv", sep=""))

data_option <- "kr-vs-kp"
df <- gendata( data_option )
write.table(df[1], paste("preproc/", data_option, "-xs.csv", sep=""))
write.table(df[2], paste("preproc/", data_option, "-ys.csv", sep=""))

data_option <- "mushroom"
df <- gendata( data_option )
write.table(df[1], paste("preproc/", data_option, "-xs.csv", sep=""))
write.table(df[2], paste("preproc/", data_option, "-ys.csv", sep=""))
